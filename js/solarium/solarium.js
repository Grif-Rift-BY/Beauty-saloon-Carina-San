...
async function moveInfoBlock() {
    ...
    $( '#PARALLAX_LAYER_2' ).css( { 'background-image': `url(../images/solarium/animation/${index}.webp)` } );
}

async function changeOpacity() {
    $( '#PARALLAX_LAYER_1' ).css( { 'opacity': '0'} );
    $( '#PARALLAX_LAYER_1' ).css( { 'background-image': `url(../images/solarium/animation/${index}.webp)` } );
